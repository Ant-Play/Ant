...
namespace Ant
{
    ...
    public class Input
    {
        ...
        /// <summary>
        /// Returns true every frame after the key was initially pressed (returns false when <see cref="Input.IsKeyPressed(KeyCodes)"/> returns true)
        /// </summary>
        public static bool IsKeyHeld(KeyCodes keycode) => InternalCalls.Input_IsKeyHeld(keycode);

        /// <summary>
        /// Returns true every frame that the key is down. Equivalent to doing <code>Input.IsKeyPressed(key) || Input.IsKeyHeld(key)</code>
        /// </summary>
        public static bool IsKeyDown(KeyCodes keycode) => InternalCalls.Input_IsKeyDown(keycode);

        /// <summary>
        /// Returns true during the frame that the key was released
        /// </summary>
        public static bool IsKeyReleased(KeyCodes keycode) => InternalCalls.Input_IsKeyReleased(keycode);
