...
namespace Ant
{
    public class AnimationSequenceTransform : AnimationSequenceGeneric<Transform>
    {
        ...
        {
            { KeyframeType.Linear, (Vector3 a, Vector3 b, float t) => Ant.Interpolate.Linear(a, b, t) },
            { KeyframeType.EaseIn, (Vector3 a, Vector3 b, float t) => Ant.Interpolate.EaseIn(a, b, t) },
            { KeyframeType.EaseOut, (Vector3 a, Vector3 b, float t) => Ant.Interpolate.EaseOut(a, b, t) },
            { KeyframeType.EaseInOut, (Vector3 a, Vector3 b,float t) => Ant.Interpolate.EaseInOut(a, b, t) },
    ...
    public class AnimationSequenceFloat : AnimationSequenceGeneric<float>
    {
        ...
        {
            { KeyframeType.Linear, (float a, float b, float t) => Ant.Interpolate.Linear(a, b, t) },
            { KeyframeType.EaseIn, (float a, float b, float t) => Ant.Interpolate.EaseIn(a, b, t) },
            { KeyframeType.EaseOut, (float a, float b, float t) => Ant.Interpolate.EaseOut(a, b, t) },
            { KeyframeType.EaseInOut, (float a, float b,float t) => Ant.Interpolate.EaseInOut(a, b, t) },
    ...
    public class AnimationSequenceVector2 : AnimationSequenceGeneric<Vector2>
    {
        ...
        {
            { KeyframeType.Linear, (Vector2 a, Vector2 b, float t) => Ant.Interpolate.Linear(a, b, t) },
            { KeyframeType.EaseIn, (Vector2 a, Vector2 b, float t) => Ant.Interpolate.EaseIn(a, b, t) },
            { KeyframeType.EaseOut, (Vector2 a, Vector2 b, float t) => Ant.Interpolate.EaseOut(a, b, t) },
            { KeyframeType.EaseInOut, (Vector2 a, Vector2 b,float t) => Ant.Interpolate.EaseInOut(a, b, t) },
