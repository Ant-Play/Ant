...
namespace Ant{
	...
	public:
		...
		virtual Ref<Image2D> GetImage(uint32_t attachmentIndex = 0) const override { ANT_CORE_ASSERT(attachmentIndex < m_ColorAttachments.size()); return m_ColorAttachments[attachmentIndex]; }
