...
namespace Ant{
	...
	void VulkanRenderer::Init()
	{
		...
		Renderer::Submit([]() mutable
			{
				auto shader = Renderer::GetShaderLibrary()->Get("AntPBR_Static");
		...
		Renderer::Submit([]()
			{
				...
				ANT_CORE_ASSERT(s_Data->ActiveCommandBuffer);
	...
	{
		//ANT_CORE_ASSERT(s_Data->m_ActiveRenderPass, "No active render pass! Have you called Renderer::EndRenderPass twice?");
