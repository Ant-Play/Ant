...
namespace Ant{
	...
	void VulkanImage2D::Release()
	{
		...
		ANT_CORE_WARN("VulkanImage2D::Release ImageView = {0}", (const void*)m_Info.ImageView);
	...
	void VulkanImage2D::UpdateDescriptor()
	{
		...
		ANT_CORE_WARN("VulkanImage2D::UpdateDescriptor to ImageView = {0}", (const void*)m_Info.ImageView);
	}
}
