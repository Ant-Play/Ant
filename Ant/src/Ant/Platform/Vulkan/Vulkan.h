...
namespace Ant{ namespace Utils{
	...
	inline void VulkanCheckResult(VkResult result)
	{
		...
		{
			ANT_CORE_ERROR("VkResult is '{0}' in {1}:{2}", ::Ant::Utils::VKResultToString(result), __FILE__, __LINE__);
			if (result == VK_ERROR_DEVICE_LOST)
			{
				using namespace std::chrono_literals;
				std::this_thread::sleep_for(3s);
				//::Ant::Utils::RetrieveDiagnosticCheckpoints();
				::Ant::Utils::DumpGPUInfo();
			}
...
{\
	VkResult res = (f);\
	::Ant::Utils::VulkanCheckResult(res);\
}

namespace Ant::VKUtils
{
