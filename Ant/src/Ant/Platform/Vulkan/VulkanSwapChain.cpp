...
namespace Ant{
	...
	void VulkanSwapChain::InitSurface(GLFWwindow* windowHandle)
	{
		...
		ANT_CORE_ASSERT(graphicsQueueNodeIndex != UINT32_MAX);
		ANT_CORE_ASSERT(presentQueueNodeIndex != UINT32_MAX);
	...
	void VulkanSwapChain::Create(uint32_t* width, uint32_t* height, bool vsync)
	{
		...
		ANT_CORE_ASSERT(presentModeCount > 0, "");
