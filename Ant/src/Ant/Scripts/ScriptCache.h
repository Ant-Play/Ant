...
#define ANT_CORE_CLASS(clazz) ScriptCache::GetManagedClassByName("Ant."#clazz)
#define ANT_CACHED_CLASS(clazz) ScriptCache::GetManagedClassByName(clazz)
#define ANT_CACHED_CLASS_RAW(clazz) ScriptCache::GetManagedClassByName(clazz)->Class
#define ANT_CACHED_METHOD(clazz, method, paramCount) ScriptCache::GetSpecificManagedMethod(ScriptCache::GetManagedClassByName(clazz), method, paramCount)
#define ANT_CACHED_FIELD(clazz, field) ScriptCache::GetFieldByName(ScriptCache::GetManagedClassByName(clazz), field)
#define ANT_CACHED_FIELD_STORAGE(clazz, field) ScriptCache::GetFieldStorage(ScriptCache::GetFieldByName(ScriptCache::GetManagedClassByName(clazz), field)->ID)
//#define ANT_TRY_GET_FIELD_VALUE(ret, className, fieldName, storageObj){\
...
//																		}\
//																	 }
#define ANT_SCRIPT_CLASS_ID(name) Hash::GenerateFNVHash(name)
