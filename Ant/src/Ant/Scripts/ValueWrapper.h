...
namespace Ant::Utils {
	...
	public:
		...
		{
			ANT_CORE_VERIFY(HasValue(), "ValueWrapper::Get - No value!");
		...
		{
			ANT_CORE_VERIFY(HasValue(), "Trying to set the value of an empty ValueWrapper!");
			...
			{
				ANT_CORE_VERIFY(m_Size == sizeof(value));
