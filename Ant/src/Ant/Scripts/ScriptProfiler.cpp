...
#define ANT_IGNORE_EXTERNAL_ALLOCATIONS
	...
	{
		ANT_CORE_ASSERT(!s_ProfilerState, "Trying to initialize Script Profiler multiple times!");
...
#ifdef ANT_IGNORE_EXTERNAL_ALLOCATIONS
