...
namespace Ant{
	...
	public:
		...
		virtual void BeginRenderPass(const Ant::Ref<Ant::RenderPass>& renderPass) = 0;
		virtual void EndRenderPass() = 0;
		virtual void SubmitFullscreenQuad(Ant::Ref<Pipeline> pipeline, Ref<Material> material) = 0;
