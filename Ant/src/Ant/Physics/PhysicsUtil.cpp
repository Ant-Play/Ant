...
namespace Ant{
	...
	{
		// TODO: I don't trust glm::toQuat because it doesn't normalize the scale
	...
	physx::PxFilterFlags AntFilterShader(physx::PxFilterObjectAttributes attributes0, physx::PxFilterData filterData0, physx::PxFilterObjectAttributes attributes1, physx::PxFilterData filterData1, physx::PxPairFlags& pairFlags, const void* constantBlock, physx::PxU32 constantBlockSize)
	{
	...
	void PhysicsMeshSerializer::SerializeMesh(const std::string& filepath, const Buffer& data)
	{
		...
		{
			ANT_CORE_INFO("File Already Exists");
		}
	}
