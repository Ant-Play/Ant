...
namespace Ant{
	...
	void ProjectSerializer::Serialize(const std::filesystem::path& filepath)
	{
		...
		out << YAML::Key << "Project" << YAML::Value;
		{
			...
			out << YAML::Key << "Audio" << YAML::Value;
			{
				...
				ANT_SERIALIZE_PROPERTY(FileStreamingDurationThreshold, userConfig.FileStreamingDurationThreshold, out);
				out << YAML::EndMap;
			}
	...
	bool ProjectSerializer::Deserialize(const std::filesystem::path& filepath)
	{
		...
		{
			auto userConfig = MiniAudioEngine::Get().GetUserConfiguration();
			ANT_DESERIALIZE_PROPERTY(FileStreamingDurationThreshold, userConfig.FileStreamingDurationThreshold, audioNode, userConfig.FileStreamingDurationThreshold);
