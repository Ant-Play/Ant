...
namespace Ant::UI
{
	...
	public:
		...
		{
			ANT_CORE_VERIFY(!(flags & ImGuiItemFlags_Disabled), "We shouldn't use ImGuiItemFlags_Disabled! Use UI::BeginDisabled / UI::EndDisabled instead. It will handle visuals for you.");
