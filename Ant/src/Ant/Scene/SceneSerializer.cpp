		...
		if (entities)
		{
			for (auto entity : entities)
			{
				...
				if (transformComponent)
				{
					...
					ANT_CORE_INFO("    Translation: {0}, {1}, {2}", translation.x, translation.y, translation.z);
					ANT_CORE_INFO("    Rotation: {0}, {1}, {2}, {3}", rotation.w, rotation.x, rotation.y, rotation.z);
					ANT_CORE_INFO("    Scale: {0}, {1}, {2}", scale.x, scale.y, scale.z);
				}
				...
				if (meshComponent)
				{
					...
					ANT_CORE_INFO("  Mesh Asset Path: {0}", meshPath);
				}
				...
				if (cameraComponent)
				{
					...
					ANT_CORE_INFO("  Primary Camera: {0}", component.Primary);
				}
