...
#include "Ant/Scripts/GCManager.h" // Needed for ScriptComponent::GCHandle
...
#include "Ant/Asset/Asset.h"
#include "Ant/Math/Math.h"
#include "Ant/Physics/3D/PhysicsTypes.h"
...
namespace Ant{
	...
	struct MeshComponent
	{
		...
		Ref<Ant::MaterialTable> MaterialTable = Ref<Ant::MaterialTable>::Create();
		...
		MeshComponent(const MeshComponent& other)
			: Mesh(other.Mesh), SubmeshIndex(other.SubmeshIndex), MaterialTable(Ref<Ant::MaterialTable>::Create(other.MaterialTable)), BoneEntityIds(other.BoneEntityIds)
		{}
	...
	struct StaticMeshComponent
	{
		...
		StaticMeshComponent(const StaticMeshComponent& other)
			: StaticMesh(other.StaticMesh), MaterialTable(Ref<Ant::MaterialTable>::Create(other.MaterialTable))
		{
		}
	...
	struct  AnimationComponent
	{
		...
		Ref<Ant::AnimationData> AnimationData = Ref<Ant::AnimationData>::Create(); // Cached info about the current "state" of animation for this component.
		...
		AnimationComponent(const AnimationComponent& other)
			...
			, AnimationData(Ref<Ant::AnimationData>::Create(other.AnimationData)) // Each AnimationComponent needs its own data
