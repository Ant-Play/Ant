...
namespace PlayerController2D
{
    class PlayerController2D : Entity
    {
        ...
        {   
            ...
            if(Input.IsKeyPressed(KeyCodes.Tab))
            {
        ...
        {
            bool spaceKeyState = Input.IsKeyPressed(KeyCodes.Space);
        ...
        {
            m_DoWallJump = (Input.IsKeyPressed(KeyCodes.Space) || Input.IsControllerButtonPressed(m_ControllerID, 0)) && m_IsOnWall;
            m_DoJump = (Input.IsKeyPressed(KeyCodes.Space) || Input.IsControllerButtonPressed(m_ControllerID, 0)) && !m_DoJump && !m_IsOnWall;
            m_DoDash = Input.IsKeyPressed(KeyCodes.C) || GetLeftTriggerAxis() != -1.0f || GetRightTriggerAxis() != -1.0f && !m_DoDash && !m_IsGrounded && m_MovementInput.Length() != 0.0f;
            m_DoAttack = (Input.IsKeyPressed(KeyCodes.X) || Input.IsControllerButtonPressed(m_ControllerID, 1)) && !m_DoAttack;
        ...
        private float GetInputH()
        {
            ...
            if (Input.IsKeyPressed(KeyCodes.A) || Input.IsKeyPressed(KeyCodes.Left))
                horizontalInput = -1.0f;
            else if (Input.IsKeyPressed(KeyCodes.D) || Input.IsKeyPressed(KeyCodes.Right))
                horizontalInput = 1.0f;
        ...
        private float GetInputV()
        {
            ...
            if (Input.IsKeyPressed(KeyCodes.W) || Input.IsKeyPressed(KeyCodes.Up))
                verticalInput = 1.0f;
            else if (Input.IsKeyPressed(KeyCodes.S) || Input.IsKeyPressed(KeyCodes.Down))
                verticalInput = -1.0f;
