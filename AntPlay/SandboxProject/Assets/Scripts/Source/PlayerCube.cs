...
namespace Example
{
    class PlayerCube : Entity
    {
        ...
        protected override void OnCreate()
        {
            ...
            {
                float x = CubeSpawnOffset.X + Ant.Random.Float() * CubeSpawnRange.X;
                float y = CubeSpawnOffset.Y + Ant.Random.Float() * CubeSpawnRange.Y;
                CreateCube(new Vector2(x, y), Ant.Random.Float() * 10.0f, i);
            }
        }
        ...
        protected override void OnUpdate(float ts)
        {
            ...
            if (Colliding && Input.IsKeyPressed(KeyCodes.Space))
